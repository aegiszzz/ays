...
-- ============================================================================
-- APP_USERS TABLE - Optimize if exists
-- ============================================================================
DO $$ 
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'app_users') THEN
    ...
    EXECUTE 'CREATE POLICY "Users can select own profile"
...
-- ============================================================================
-- WALLETS TABLE - Optimize if exists
-- ============================================================================
DO $$ 
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'wallets') THEN
    ...
    EXECUTE 'CREATE POLICY "Users can select own wallet"
      ON wallets FOR SELECT
      TO authenticated
      USING (user_id = (select auth.uid()))';
      
    EXECUTE 'CREATE POLICY "Users can insert own wallet"
...
-- ============================================================================
-- MEDIA_FILES TABLE - Optimize if exists
-- ============================================================================
DO $$ 
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'media_files') THEN
    ...
    EXECUTE 'CREATE POLICY "Users can select own files"
      ON media_files FOR SELECT
      TO authenticated
      USING (user_id = (select auth.uid()))';
      
    EXECUTE 'CREATE POLICY "Users can insert files"
      ON media_files FOR INSERT
      TO authenticated
      WITH CHECK (user_id = (select auth.uid()))';
      
    EXECUTE 'CREATE POLICY "Users can delete own files"
...
-- ============================================================================
-- MEDIA_ACCESS TABLE - Optimize if exists
-- ============================================================================
DO $$ 
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'media_access') THEN
    DROP POLICY IF EXISTS "Users can view own access records" ON media_access;
    DROP POLICY IF EXISTS "Users can delete access records" ON media_access;
    
    EXECUTE 'CREATE POLICY "Users can select own access"
      ON media_access FOR SELECT
      TO authenticated
      USING (user_id = (select auth.uid()))';
      
    EXECUTE 'CREATE POLICY "Users can delete own access"
...
DROP INDEX IF EXISTS idx_media_access_user_id;
